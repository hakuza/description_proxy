    ...
    if (e.key === "Enter" || e.type === "click") {
      ...
      bolded.forEach(review => {
        ...
        review.content = review
          .content
          .replace(re, "<span>$&</span>");
      });
      this.setState({searchResults: bolded});
    }
  }

  handleStarsClick(e) {
    let filteredStarsReviews = this
      .state
      .courseReview
      .filter(review => {
    ...
    this.setState({searchResults: filteredStarsReviews});
  }
  ...
  render() {
    return (
      <div>
        ...
        <Ratings reviews={this.state.courseReview} click={this.handleStarsClick}/>
